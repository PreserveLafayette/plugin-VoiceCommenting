...
class Api_VoiceComment extends Omeka_Record_Api_AbstractRecordAdapter implements Zend_Acl_Resource_Interface
{
    ...
    public function getRepresentation(Omeka_Record_AbstractRecord $comment)
    {
        ...
        $representation = array(
                'id' => $comment->id,
                'url' => self::getResourceUrl("/voicecommenting/{$comment->id}"),
        ...
        if($comment->parent_comment_id) {
            $representation['parent_comment'] = array(
                    ...
                    'resource' => 'voicecomments',
                    'url' => self::getResourceUrl("/voicecommenting/{$comment->parent_comment_id}")
                    );
        } else {
        ...
        if($user && is_allowed('VoiceCommenting_Comment', 'update-approved')) {
    ...
    {
        return "VoiceCommenting_Comment";
    }
