...
class VoiceCommenting_CommentForm extends Omeka_Form
{

    public function init()
    {
        parent::init();
        $this->setAction(WEB_ROOT . '/voicecommenting/comment/add');
        $this->setAttrib('id', 'voice-comment-form');
        $user = current_user();
        ...
        fire_plugin_hook('voice_commenting_form', array('voice_comment_form' => $this) );
	$this->addElement('hidden', 'comment_url', array('value'=>$params['comment_url'], 'decorators'=>array('ViewHelper')));
