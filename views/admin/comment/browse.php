...
$pageTitle = __('VoiceComments') . ' ' . __('(%s total)', $total_results);
...
<?php if(is_allowed('VoiceCommenting_Comment', 'update-approved') ) : //updateapproved is standing in for all moderation options?>
